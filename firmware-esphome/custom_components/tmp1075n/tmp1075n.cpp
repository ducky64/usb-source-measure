...
static const char *const TAG = "tmp1075n";
...
void TMP1075NSensor::dump_config() {
...
void TMP1075NSensor::set_fault_count(const int faults) {
  if (faults < 1) {
...
void TMP1075NSensor::log_config_() {
...
void TMP1075NSensor::write_config() {
  send_alert_limit_low_();
  send_alert_limit_high_();
  send_config_();
}

void TMP1075NSensor::send_config_() {
...
void TMP1075NSensor::send_alert_limit_low_() {
...
void TMP1075NSensor::send_alert_limit_high_() {
